...
uploaded_a = st.file_uploader("Upload Source A ", type=["pdf", "csv", "xls", "xlsx"], accept_multiple_files=True, key="source_a")
uploaded_b = st.file_uploader("Upload Source B ", type=["pdf", "csv", "xls", "xlsx"], accept_multiple_files=True, key="source_b")
