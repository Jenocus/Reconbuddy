...
st.write("- ✏️ Edit mismatch reasons across all, matched, and unmatched tabs with cross-tab synchronization")
st.write("- 📚 Learn from user-confirmed reasons via knowledge base (remembers field pairings and mismatch patterns)")
st.write("- ⏰ Automatically detect timing differences by comparing transaction dates to matched period")
st.write("- 💬 Ask questions about the sources and reconciliation results via LLM chatbox")
